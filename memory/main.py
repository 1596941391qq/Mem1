...
class Memory(MemoryBase):
    ...
    def _add_to_vector_store(self, messages, metadata, filters):
        ...
        logging.info(new_memories_with_actions)
        match2 = re.search(r'(\[.*?])', new_memories_with_actions, re.DOTALL)
        new_memories_list = match2.group(0)
        new_memories_list = json.loads(new_memories_list)
        new_memories_with_actions = {"memory": new_memories_list}
        returned_memories = []
        try:
